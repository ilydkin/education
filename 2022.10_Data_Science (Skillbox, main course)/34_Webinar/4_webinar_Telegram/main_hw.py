...
model = os.path.join(os.path.expanduser('~'), '00_Webinar', 'lyrics-generator', 'export', 'model.h5')
tokenizer = os.path.join(os.path.expanduser('~'), '00_Webinar', 'lyrics-generator', 'export', 'tokenizer.pickle')
tg_token ='6045058090:AAGgou6V7rYHANPbDuwr7_tgHz8lVJzU-BQ'
